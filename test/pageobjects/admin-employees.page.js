class adminEmployees {
  ...
  get firstNameSortDown() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(1) > svg.svg-inline--fa.fa-arrow-down'
    );
  }
  get firstNameSortUp() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(1) > svg.svg-inline--fa.fa-arrow-up'
    );
  }
  get lastNameSortDown() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(2) > svg.svg-inline--fa.fa-arrow-down'
    );
  }
  get lastNameSortUp() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(2) > svg.svg-inline--fa.fa-arrow-up'
    );
  }
  get phoneSortDown() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(3) > svg.svg-inline--fa.fa-arrow-down'
    );
  }
  get phoneSortUp() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(3) > svg.svg-inline--fa.fa-arrow-up'
    );
  }
  get emailSortDown() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(4) > svg.svg-inline--fa.fa-arrow-down'
    );
  }
  get emailSortUp() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(4) > svg.svg-inline--fa.fa-arrow-up'
    );
  }
  get activeSortDown() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(5) > svg.svg-inline--fa.fa-arrow-down'
    );
  }
  get activeSortUp() {
    return $(
      '#root > div > div > section > table > thead > tr > th:nth-child(5) > svg.svg-inline--fa.fa-arrow-up'
    );
  }
