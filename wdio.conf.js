exports.config = {
    ...
    specs: [
        ...
        './test/specs/timesheetsAdminPage.js',
        './test/specs/tasksAdminPage.js',
        './test/specs/employeeHomePage.js',
        './test/specs/projectsEmployeePage.js',
        './test/specs/timesheetsEmployeePage.js',
        './test/specs/profilePage.js',
    ],
    // Patterns to exclude.
    exclude: [
